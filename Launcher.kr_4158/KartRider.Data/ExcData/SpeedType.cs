...
namespace ExcData
{
    public class SpeedType
    {
        ...
        public static void SpeedTypeData()
        {
            ...
            else if (StartGameData.StartTimeAttack_SpeedType == 0 || StartGameData.StartTimeAttack_SpeedType == 4)//S1 빠름
            {
            ...
            else if (StartGameData.StartTimeAttack_SpeedType == 1 || StartGameData.StartTimeAttack_SpeedType == 6)//S2 매우빠름
            {
            ...
            else if (StartGameData.StartTimeAttack_SpeedType == 7)//통합
            {
